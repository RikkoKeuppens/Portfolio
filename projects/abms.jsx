       ...
       <div>
           ...
           <div className='w-full sm:block md:flex'>
               <div className='sm:w-full md:w-1/2 pr-4'>
                   ...
                   <p className='text-justify'>For the development of our application, we utilized Vue.js for the frontend, .NET for the backend API, and SQL for our database management. The AI team employed Python for the detection algorithms. As for hosting, we opted for Azure to ensure seamless deployment and availability of our application.</p>
